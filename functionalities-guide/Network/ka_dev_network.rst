...
=======
   ...
   starting from your data. Now let see how. What is a network? It’s a
   set of nodes linked by relations. So it’s a 3-tuple where the
   entities are:
...
----------------
   ...
   **knowagenetworkanalysisengine** supports different types of network
   ...
   that’s it. After this operation you can open your network using
   Knowage.
