...
======================
   ...
   In case the certificate “self-signed”, it must be inserted in the CA
...
..
   ...
   “keytool” utility if the user intends to install a self-signed
   certificate:
...
-  set the certificate inside the CA certificates of the JDK to make it
   ...
   default one is "changeit“ refer to Code
