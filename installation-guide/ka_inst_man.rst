...
=================================
   ...
   information related to the metadata database inside the “datasources”
...
==============================================
   ...
   ”org.quartz.jobStore.driverDelegateClass“ with the right value,
...
===============
   ...
   *\\*\ WEB-INF\ *\\*\ classes\ *\\* available in each web application.
   ...
   the following steps: • create the LOG_DIR folder on all cluster nodes
...
-  |image32| verify that Knowage has write permissions on this folder; •
...
..
   ...
   files substitute the string ”catalina.base/logs“ with
...
-  uncomment all blocks bounded by the comments “START JBOSS RES” and
   “END JBOSS RES”;

-  comment all blocks bounded by the comments “START TOMCAT RES” and
   “END TOMCAT RES”;

-  comment all blocks bounded by the comments “START
   ProxyTicketReceptor” and “END ProxyTicketReceptor”.
