...
=====================
   ...
   in the ”member“ tag the IP address or hostname of the machine on
...
======================
   ...
   Knowage server application as administrator and access the ”server
   settings“ section and then ”configuration management“. The parameters
...
..
   ...
   9.6. Date format • SPAGOBI.DOCUMENTS.MAX_PREVIEW_IMAGE_SIZE : Max
...
================
   ...
   "Server Settings“ section and, consequently, the ”Configuration
   management“. Then finally select ”\ **DATE-FORMAT**\ “.
...
=============
   ...
   Settings” section. Go to "Configuration management“ and select the
...
-  the environment to use the class
   ...
   -  set the value
      ...
      it.eng.spagobi.adam.AdamAuthorization and confirm, – log out of
      Knowage.
